...
The public API lives at the module root (`github.com/go-ruby-net-pop/net-pop`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `net-pop`, while the surface follows
...
```go
import "github.com/go-ruby-net-pop/net-pop"
```
...
- **[pkg.go.dev/github.com/go-ruby-net-pop/net-pop](https://pkg.go.dev/github.com/go-ruby-net-pop/net-pop)**

The module's [README](https://github.com/go-ruby-net-pop/net-pop#readme) carries worked
