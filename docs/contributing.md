...
Contributions are welcome. `go-ruby-net-pop/net-pop` is built to a small set of
...
The library is in [`github.com/go-ruby-net-pop/net-pop`](https://github.com/go-ruby-net-pop/net-pop).
This documentation site is in [`github.com/go-ruby-net-pop/docs`](https://github.com/go-ruby-net-pop/docs).
