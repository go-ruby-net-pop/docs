# go-ruby-net-pop documentation

**Pure-Go, MRI-4.0.5-faithful Ruby net-pop (no cgo)**

`go-ruby-net-pop/net-pop` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `net-pop`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-net-pop/net-pop`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `net-pop`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-net-pop/net-pop
```
...
| Repo | What it is |
| --- | --- |
| [`net-pop`](https://github.com/go-ruby-net-pop/net-pop) | the library — Ruby's `net-pop` in pure Go |
| [`docs`](https://github.com/go-ruby-net-pop/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-net-pop.github.io`](https://github.com/go-ruby-net-pop/go-ruby-net-pop.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-net-pop/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-net-pop/net-pop](https://github.com/go-ruby-net-pop/net-pop).
