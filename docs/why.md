...
`go-ruby-net-pop/net-pop` reimplements Ruby's `net-pop` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-net-pop/net-pop` directly, with no Ruby runtime;
